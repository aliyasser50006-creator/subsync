...
const VideoPlayer = dynamic(() => import('@/components/VideoPlayer'), {
  ...
  loading: () => (
    <div className="aspect-video w-full rounded-xl bg-slate-950 flex flex-col items-center justify-center border border-border/40 shadow-soft">
      ...
      <p className="text-sm font-semibold text-slate-200">Initializing Media Workstation...</p>
      <p className="text-xs text-slate-400 font-mono mt-1">Loading audio/video engine</p>
    </div>
  ),
});
