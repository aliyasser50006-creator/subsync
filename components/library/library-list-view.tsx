          ...
          return (
            ...
            >
              <div className="flex min-w-0 items-center gap-3.5">
                <div className="relative flex h-10 w-16 shrink-0 items-center justify-center overflow-hidden rounded-lg bg-primary/10 border border-primary/20 text-primary shadow-xs"><Play className="h-4 w-4 fill-current" /></div>
