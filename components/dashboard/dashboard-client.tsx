...
export function DashboardClient({ initialCategories = [], initialActors = [] }: DashboardClientProps) {
  const { user } = useAuth();
    ...
    <form onSubmit={handleSubmit} className="grid gap-6 xl:grid-cols-[minmax(400px,1fr)_minmax(500px,1.4fr)]">
      <div className="space-y-6">
        ...
        <MetadataCard 
          ...
          categoryIds={categoryIds} onCategoryIdsChange={setCategoryIds}
          actorIds={actorIds} onActorIdsChange={setActorIds}
          categories={initialCategories} actors={initialActors}
        />
