...
export async function PATCH(request: Request) {
  try {
    ...
    const hasImgUrl = 'imgUrl' in body;
    const imgUrl = typeof body.imgUrl === 'string' && body.imgUrl.trim() ? body.imgUrl.trim() : null;
    ...
    if (imgUrl && !isValidVideoUrl(imgUrl)) {
